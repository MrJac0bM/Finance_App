...
fun BottomNavigationBar(onItemSelected: (Int) -> Unit, modifier: Modifier){
    NavigationBar(containerColor = colorResource(R.color.lightBlue),
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    painter = painterResource(R.drawable.wallet), contentDescription = null
                )
            },
            label = { Text("Home") }
        )
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    painter = painterResource(R.drawable.market), contentDescription = null
                )
            },
            label = { Text("Market") }
        )
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    painter = painterResource(R.drawable.trade), contentDescription = null
                )
            },
            label = { Text("Trade") }
        )
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    painter = painterResource(R.drawable.futures), contentDescription = null
                )
            },
            label = { Text("Futures") }
        )
